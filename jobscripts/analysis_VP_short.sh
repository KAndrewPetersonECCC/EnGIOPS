#!/bin/bash -x
#ord_soumet /home/dpe000/EnGIOPS/jobscripts/analysis_VP_short.sh -cpus 20 -cm 64000M -t 21600 -shell=/bin/bash
...
a_dates = rank_histogram.create_dates(20210602, 20210602, 7)
...
read_DF_VP.produce_stats_plot( JUN_dates, expts, enss, labels=labels, outdir=outdir, mp_expt=False, mp_read=True)
print("FINISHED JUN DATES")
