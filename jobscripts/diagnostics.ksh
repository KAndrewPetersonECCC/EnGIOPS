#!/bin/ksh
#ord_soumet /fs/homeu1/eccc/mrd/ords/rpnenv/dpe000/EnGIOPS/jobscripts/diagnostics.ksh -cpus 1 -mpi -cm 8000M -t 10800 -shell=/bin/bash
...
if [ "${run_VP_dia}" = "T" ]; then
   echo "Running GIOPS_VP_dia_general_plot_v3.py"
   python GIOPS_VP_dia_general_plot_v3.py  \
       --suite ${suite} \
       --ref_suite ${reference_suite} \
       --path ${input_path}  \
       --ref_path ${input_reference_path} \
