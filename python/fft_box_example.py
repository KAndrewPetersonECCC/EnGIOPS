...
kw, psd_v = scipy.signal.welch(sub_C, 1, axis=0, window='box')
kw, psd_u = scipy.signal.welch(sub_C, 1, axis=1, window='box')
psa_v = np.mean(psd_v, axis=1)  # actually x
psa_u = np.mean(psd_u, axis=0)  # actually y

ka, pad_v = scipy.signal.welch(sub_A, 1, axis=0, window='box')
ka, pad_u = scipy.signal.welch(sub_A, 1, axis=1, window='box')
...
fig.savefig('PSDD_box/PSD_EG1.png')
plt.close()
...
fig.savefig('PSDD_box/PSD_EG3.png')
plt.close()
...
fig.savefig('PSDD_box/PSD_EGW.png')
plt.close()
...
fig.savefig('PSDD_box/PSD_EGF.png')
plt.close()
...
fig.savefig('PSDD_box/PSD_EGD.png')
plt.close()
...
fig.savefig('PSDD_box/PSD_EGR.png')
plt.close()
