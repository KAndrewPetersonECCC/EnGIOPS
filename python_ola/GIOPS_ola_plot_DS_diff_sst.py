...
def plot_SST_misfit_rms_difference_map(df1, df2, typ):
    ...
    if typ == 'SST':
        ...
        plt.figtext(0.5, 0.95, suite_name + ' vs ' + ref_suite_name +' : SST_NIGHT vs SST misfit difference in deg', fontsize=16, ha='center')
...
plot_SST_misfit_rms_difference_map(df_s_SST_NIGHT, df_r_SST, 'SST_NIGHT')
