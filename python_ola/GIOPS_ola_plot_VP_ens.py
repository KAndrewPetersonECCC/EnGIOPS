...
for num_dates in range(len(dates)):
    ...
    rga_VP, iga_VP = ola_functions.read_data(input_file, 'VP')
...
T_data_5['mean_bias'] = ola_functions.weighted_average(df_global_5, 'misfit_T_avg', 'obs_count_T', ['lat_int', 'lon_int'])
T_data_5['mean_rms'] = ola_functions.weighted_average(df_global_5, 'rms_T', 'obs_count_T', ['lat_int','lon_int'])

# Salinity
S_data_5 = df_global_5.groupby(['lat_int','lon_int'], as_index=False).sum()[['lat_int', 'lon_int', 'obs_count_S']]
S_data_5['mean_bias'] = ola_functions.weighted_average(df_global_5, 'misfit_S_avg', 'obs_count_S', ['lat_int', 'lon_int'])
S_data_5['mean_rms'] = ola_functions.weighted_average(df_global_5, 'rms_S', 'obs_count_S', ['lat_int', 'lon_int'])

# 10m
# Temperature
T_data_10 = df_global_10.groupby(['lat_int', 'lon_int'], as_index=False).sum()[['lat_int', 'lon_int', 'obs_count_T']]
T_data_10['mean_bias'] = ola_functions.weighted_average(df_global_10, 'misfit_T_avg', 'obs_count_T', ['lat_int', 'lon_int'])
T_data_10['mean_rms'] = ola_functions.weighted_average(df_global_10, 'rms_T', 'obs_count_T', ['lat_int', 'lon_int'])

# Salinity
S_data_10 = df_global_10.groupby(['lat_int', 'lon_int'], as_index=False).sum()[['lat_int', 'lon_int', 'obs_count_S']]
S_data_10['mean_bias'] = ola_functions.weighted_average(df_global_10, 'misfit_S_avg', 'obs_count_S', ['lat_int', 'lon_int'])
S_data_10['mean_rms'] = ola_functions.weighted_average(df_global_10, 'rms_S', 'obs_count_S', ['lat_int', 'lon_int'])

# 500m
# Temperature
T_data_500 = df_global_500.groupby(['lat_int', 'lon_int'], as_index=False).sum()[['lat_int', 'lon_int', 'obs_count_T']]
T_data_500['mean_bias'] = ola_functions.weighted_average(df_global_500, 'misfit_T_avg', 'obs_count_T', ['lat_int', 'lon_int'])
T_data_500['mean_rms'] = ola_functions.weighted_average(df_global_500, 'rms_T', 'obs_count_T', ['lat_int', 'lon_int'])

# Salinity
S_data_500 = df_global_500.groupby(['lat_int', 'lon_int'], as_index=False).sum()[['lat_int', 'lon_int', 'obs_count_S']]
S_data_500['mean_bias'] = ola_functions.weighted_average(df_global_500, 'misfit_S_avg', 'obs_count_S', ['lat_int', 'lon_int'])
S_data_500['mean_rms'] = ola_functions.weighted_average(df_global_500, 'rms_S', 'obs_count_S', ['lat_int', 'lon_int'])

# 50m
# Temperature
T_data_50 = df_global_50.groupby(['lat_int', 'lon_int'], as_index=False).sum()[['lat_int', 'lon_int', 'obs_count_T']]
T_data_50['mean_bias'] = ola_functions.weighted_average(df_global_50, 'misfit_T_avg', 'obs_count_T', ['lat_int', 'lon_int'])
T_data_50['mean_rms'] = ola_functions.weighted_average(df_global_50, 'rms_T', 'obs_count_T', ['lat_int', 'lon_int'])

# Salinity
S_data_50 = df_global_50.groupby(['lat_int', 'lon_int'], as_index=False).sum()[['lat_int', 'lon_int', 'obs_count_S']]
S_data_50['mean_bias'] = ola_functions.weighted_average(df_global_50, 'misfit_S_avg', 'obs_count_S', ['lat_int', 'lon_int'])
S_data_50['mean_rms'] = ola_functions.weighted_average(df_global_50, 'rms_S', 'obs_count_S', ['lat_int', 'lon_int'])

# 500-2000m
# Temperature
T_data_500_2000 = df_global_500_2000.groupby(['lat_int', 'lon_int'], as_index=False).sum()[['lat_int', 'lon_int', 'obs_count_T']]
T_data_500_2000['mean_bias'] = ola_functions.weighted_average(df_global_500_2000, 'misfit_T_avg', 'obs_count_T', ['lat_int', 'lon_int'])
T_data_500_2000['mean_rms'] = ola_functions.weighted_average(df_global_500_2000, 'rms_T', 'obs_count_T', ['lat_int', 'lon_int'])

# Salinity
S_data_500_2000 = df_global_500_2000.groupby(['lat_int', 'lon_int'], as_index=False).sum()[['lat_int', 'lon_int', 'obs_count_S']]
S_data_500_2000['mean_bias'] = ola_functions.weighted_average(df_global_500_2000, 'misfit_S_avg', 'obs_count_S', ['lat_int', 'lon_int'])
S_data_500_2000['mean_rms'] = ola_functions.weighted_average(df_global_500_2000, 'rms_S', 'obs_count_S', ['lat_int', 'lon_int'])
